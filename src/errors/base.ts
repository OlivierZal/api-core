/**
 * Base class for all errors thrown by the SDK family. Each consuming
 * SDK's protocol errors extend this one class, so a host can catch the
 * whole hierarchy through {@link isAPIError} whatever wire it talks to.
 * @category Errors
 */
